---
subtitle: "where and how to begin"
---
# Starting

## A Framework

-   {{<g innovation-diffusion "Diffusion of innovations" >}} model [@Rogers2003]
-   Steps are:
...
For example, the one presented in [@Heath2010]
...
1.  Pick something that is *immediately useful*
    -   Remember, most innovations languish or are met with {{<g passive-resistance "passive resistance" >}}
        [@Scott1987]
...
-   A {{<g connector "Connector" >}} is someone who knows everyone [@Manns2015]
    -   Help you spread the word
    -   Will expect you to listen to others in turn (exchange of social capital)
-   A {{<g guru "Guru" >}} is someone whose expertise in some domain is widely respected
    -   "If Toby likes it, it must be good"

## Who Not To Start With

-   An {{<g innovator "Innovator" >}} is someone who is constantly trying new things
    -   Less persuasive because they are known to abandon most of the things they try
-   {{<g decision-owner "Decision Owners" >}} actually has the authority to make the change
...
-   Organize orientation and training for junior staff on how to contribute
    ...
    -   "Here's the [Code of Conduct](../conduct/index.qmd) that most open source projects use"
...
1.  Individually, make a short list of connectors, gurus, and/or innovators in your organization.
